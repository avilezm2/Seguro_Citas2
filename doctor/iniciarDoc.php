...
<html>
    ...
    <body>
        ...
        <section class="form-registerLong">
            <form action="Main_doc.php" method="POST">
                <?php
                    $sql = "SELECT idDoc, nombre, paterno, materno FROM doctor WHERE user = '$user' AND pass = '$pass'";
                    ...
                    if ($resultado->num_rows > 0) {
                        ...
                        echo "<input class='botones' type='button' onclick='location.href=`inicioSesionDoc.html`' value='Inténtalo de nuevo'>";
                    }
